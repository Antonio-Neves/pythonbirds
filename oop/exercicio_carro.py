...
class Direcao:
	...
	def girar_a_direita(self):
		self.valor = self.direcao_possivel[self.valor]

	def girar_a_esquerda(self):
		chaves = list(self.direcao_possivel.keys())
		valores = list(self.direcao_possivel.values())

		self.valor = chaves[valores.index(self.valor)]
...
movimentos_motor = {'w': '1'}

direcao = Direcao()
motor = Motor()
carro_01 = Carro(direcao, motor)
